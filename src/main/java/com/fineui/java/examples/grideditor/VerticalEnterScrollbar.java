...
/**
 * 单元格编辑（Enter 纵向导航，自动滚动）：表格设固定高度出现滚动条，键盘导航时自动调整滚动条位置，
 * 确保当前选中单元格始终可见。保存时把用户修改的数据重新绑定并展示 JSON。
 */
@FineUIPage("grid-editor/vertical-enter-scrollbar")
public class VerticalEnterScrollbar extends PageBase {
