...
/**
 * 单元格编辑（Enter 与 Tab 相同，横向导航）：Enter、Tab 键进入水平方向的下一个可编辑单元格，
 * Shift+Enter、Shift+Tab 回退到上一个单元格。保存时把用户修改的数据重新绑定并展示 JSON。
 */
@FineUIPage("grid-editor/enter-same-as-tab")
public class EnterSameAsTab extends PageBase {
