...
/**
 * 单元格编辑（Tab 键只在可编辑单元格之间导航）：性别列不可编辑，Tab 键会跳过它，
 * 只在可编辑单元格之间移动。保存时把用户修改的数据重新绑定并展示 JSON。
 */
@FineUIPage("grid-editor/tab-editable-cell")
public class TabEditableCell extends PageBase {
