...
/**
 * 单元格编辑（Enter 纵向导航，最后自动点击保存按钮）：在最后一个可编辑单元格按下 Enter 键时，
 * 客户端监听 beforetabedit 事件并触发[保存数据]按钮的点击。保存时把用户修改的数据重新绑定并展示 JSON。
 */
@FineUIPage("grid-editor/vertical-enter-to-save")
public class VerticalEnterToSave extends PageBase {
