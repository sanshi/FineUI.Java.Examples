...
/**
 * 单元格编辑（Enter 横向导航，Tab 纵向导航）：Tab 键在垂直方向移动，Enter 键在水平方向移动。
 * 保存时把用户修改的数据重新绑定并展示 JSON。
 */
@FineUIPage("grid-editor/vertical-tab-horizontal-enter")
public class VerticalTabHorizontalEnter extends PageBase {
