...
/**
 * 节点选择（禁止选中节点，默认选中）（路由 {@code tree/tree-select-multi-selectable-selected}）：多选树，
 * 部分目录节点 selectable=false 不可选中，且含默认选中节点；服务端读取当前多选节点列表，并可继续追加选中节点。
 */
@FineUIPage("tree/tree-select-multi-selectable-selected")
public class TreeSelectMultiSelectableSelected extends PageBase {
