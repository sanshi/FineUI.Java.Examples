...
/**
 * 内联表头过滤 · 列表多选（路由 {@code grid-filter/inline-filter-drop-down-list}）：所学专业列用内联下拉多选
 * （Tags 模式）过滤，下拉直接内嵌在表头；源值等于任一选中项即命中。
 */
@FineUIPage("grid-filter/inline-filter-drop-down-list")
public class InlineFilterDropDownList extends PageBase {
