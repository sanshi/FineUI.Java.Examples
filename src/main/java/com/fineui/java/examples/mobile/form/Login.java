...
/**
 * 移动端系统登录演示页（路由 {@code mobile/form/login}）：登录按钮内置表单校验（{@code validate-forms}），
 * 客户端校验通过后回发校验账号，居中通知登录结果。
 */
@FineUIPage("mobile/form/login")
public class Login extends MobilePageBase {
