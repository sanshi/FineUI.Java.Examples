...
/**
 * 下拉单选框列表演示页（路由 {@code drop-down-box/radio-button-list}）：下拉框的弹出面板内放一个
 * RadioButtonList，选中某项后其值/文本同步进下拉框；「获取下拉框的选中值」回发读取下拉框当前文本与值。
 */
@FineUIPage("drop-down-box/radio-button-list")
