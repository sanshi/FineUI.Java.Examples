...
/**
 * 多选标签（下拉表格，后台更新选中值）演示页（路由 {@code drop-down-box/tags-grid-multi-select-update-value}）：
 * 「更新下拉框的值为[陈飞,黄婷婷,张三石]」在服务端改多选值集合、文本置空（未分页表格可置空由客户端按表格行数据重算）。
 */
@FineUIPage("drop-down-box/tags-grid-multi-select-update-value")
public class TagsGridMultiSelectUpdateValue extends PageBase {
