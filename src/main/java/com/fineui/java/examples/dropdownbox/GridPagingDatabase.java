...
/**
 * 下拉表格（数据库分页，路由 {@code drop-down-box/grid-paging-database}）：弹出面板内的多选表格开启数据库分页，
 * 每次翻页服务端只返回当前页数据（须先设总记录数）；跨页选中由客户端选中缓存保留。
 */
@FineUIPage("drop-down-box/grid-paging-database")
public class GridPagingDatabase extends PageBase {
