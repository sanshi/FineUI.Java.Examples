...
/** 表格为空的提示（绝对定位）（路由 {@code grid-other/empty-text-few-columns}）：无数据时显示空信息；「重新绑定表格」按钮切换有/无数据。 */
@FineUIPage("grid-other/empty-text-few-columns")
public class EmptyTextFewColumns extends PageBase {
