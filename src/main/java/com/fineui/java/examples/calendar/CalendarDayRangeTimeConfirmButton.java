...
/** 带时间与确定按钮的日期范围日历（路由 {@code calendar/calendar-day-range-time-confirm-button}）：点日期不回发，点“确定”才提交。 */
@FineUIPage("calendar/calendar-day-range-time-confirm-button")
public class CalendarDayRangeTimeConfirmButton extends PageBase {
