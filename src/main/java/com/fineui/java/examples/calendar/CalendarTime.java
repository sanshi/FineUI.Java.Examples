...
/** 带时间的日历（路由 {@code calendar/calendar-time}）：ShowTime=true，日期网格旁附时/分/秒选择列，底部按钮为“现在”。 */
@FineUIPage("calendar/calendar-time")
public class CalendarTime extends PageBase {
