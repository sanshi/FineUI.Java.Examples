...
/** 时间范围选择日历（路由 {@code calendar/calendar-time-range}）：DisplayType=TimeRange，两组时间条选起止时间。 */
@FineUIPage("calendar/calendar-time-range")
public class CalendarTimeRange extends PageBase {
