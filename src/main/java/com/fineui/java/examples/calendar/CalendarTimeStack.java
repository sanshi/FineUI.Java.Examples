...
/** 日期/时间面板层叠显示的日历（路由 {@code calendar/calendar-time-stack}）：ShowTime=true、StackDateTime=true。 */
@FineUIPage("calendar/calendar-time-stack")
public class CalendarTimeStack extends PageBase {
