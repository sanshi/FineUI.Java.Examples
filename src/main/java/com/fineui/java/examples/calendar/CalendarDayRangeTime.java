...
/** 带时间的日期范围日历（路由 {@code calendar/calendar-day-range-time}）：DisplayType=DayRange、ShowTime=true，起止各带时间。 */
@FineUIPage("calendar/calendar-day-range-time")
public class CalendarDayRangeTime extends PageBase {
