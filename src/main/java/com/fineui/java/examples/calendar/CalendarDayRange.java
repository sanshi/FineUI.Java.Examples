...
/** 日期范围选择日历（路由 {@code calendar/calendar-day-range}）：DisplayType=DayRange，双月面板选起止日期。 */
@FineUIPage("calendar/calendar-day-range")
public class CalendarDayRange extends PageBase {
