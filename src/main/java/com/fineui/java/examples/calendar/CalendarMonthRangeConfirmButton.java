...
/** 带确定按钮的月份范围日历（路由 {@code calendar/calendar-month-range-confirm-button}）。 */
@FineUIPage("calendar/calendar-month-range-confirm-button")
public class CalendarMonthRangeConfirmButton extends PageBase {
