...
/** 带确定按钮的日历（路由 {@code calendar/calendar-time-confirm-button}）：ShowConfirmButton=true、ConfirmToSelect=true，点确定才算选中并回发。 */
@FineUIPage("calendar/calendar-time-confirm-button")
public class CalendarTimeConfirmButton extends PageBase {
