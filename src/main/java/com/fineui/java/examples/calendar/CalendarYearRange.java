...
/** 年份范围选择日历（路由 {@code calendar/calendar-year-range}）：DisplayType=YearRange，选起止年份。 */
@FineUIPage("calendar/calendar-year-range")
public class CalendarYearRange extends PageBase {
