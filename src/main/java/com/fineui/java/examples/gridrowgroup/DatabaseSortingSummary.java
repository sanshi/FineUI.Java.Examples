...
/** 行分组（数据库分页与排序，分组合计，路由 {@code grid-row-group/database-sorting-summary}）。 */
@FineUIPage("grid-row-group/database-sorting-summary")
public class DatabaseSortingSummary extends PageBase {
