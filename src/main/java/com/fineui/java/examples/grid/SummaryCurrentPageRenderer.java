...
/** 合计行（当前页合计 + 合计单元格渲染函数）（路由 {@code grid/summary-current-page-renderer}）：合计行显示当前页的学费/学杂费合计，翻页时按当前页重算。 */
@FineUIPage("grid/summary-current-page-renderer")
public class SummaryCurrentPageRenderer extends PageBase {
