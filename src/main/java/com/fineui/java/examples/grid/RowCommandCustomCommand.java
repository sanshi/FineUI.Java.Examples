...
/** 行命令（执行前台事件，阻止后台事件）（路由 {@code grid/row-command-custom-command}）。 */
@FineUIPage("grid/row-command-custom-command")
public class RowCommandCustomCommand extends PageBase {
