...
/** 单元格样式（列渲染函数 params.cellAttrs）（路由 {@code grid/style-cell-renderer-attrs}）。 */
@FineUIPage("grid/style-cell-renderer-attrs")
public class StyleCellRendererAttrs extends PageBase {
