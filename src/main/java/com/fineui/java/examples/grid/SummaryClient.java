...
/** 合计行（纯客户端合计：求和）（路由 {@code grid/summary-client}）：合计由客户端按当前页数据计算（列声明 summary-type / summary-renderer-function）。 */
@FineUIPage("grid/summary-client")
public class SummaryClient extends PageBase {
