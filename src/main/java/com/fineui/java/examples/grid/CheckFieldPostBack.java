...
/**
 * 复选框列（自定义选中改变事件，路由 {@code grid/check-field-post-back}）：点击复选框把行 id/文本/勾选态
 * 经自定义事件回发服务端，服务端弹出通知。
 */
@FineUIPage("grid/check-field-post-back")
public class CheckFieldPostBack extends PageBase {
