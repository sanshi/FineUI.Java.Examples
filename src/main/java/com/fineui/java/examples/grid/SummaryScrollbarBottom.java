...
/** 合计行（Bottom 位置，固定底部）（路由 {@code grid/summary-scrollbar-bottom}）：合计行显示当前页的学费/学杂费合计，翻页时按当前页重算。 */
@FineUIPage("grid/summary-scrollbar-bottom")
public class SummaryScrollbarBottom extends PageBase {
