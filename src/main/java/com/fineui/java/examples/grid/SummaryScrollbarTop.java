...
/** 合计行（Top 位置，固定顶部）（路由 {@code grid/summary-scrollbar-top}）：合计行显示当前页的学费/学杂费合计，翻页时按当前页重算。 */
@FineUIPage("grid/summary-scrollbar-top")
public class SummaryScrollbarTop extends PageBase {
