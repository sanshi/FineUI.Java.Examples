...
/** 合计行（纯客户端合计：平均值 + 数值格式）（路由 {@code grid/summary-client-argument}）：合计由客户端按当前页数据计算（列声明 summary-type / summary-renderer-function）。 */
@FineUIPage("grid/summary-client-argument")
public class SummaryClientArgument extends PageBase {
