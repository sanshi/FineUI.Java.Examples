...
/** 编辑框（单选按钮）（路由 {@code grid-input/radio-button-list}）：单元格内渲染表单控件，客户端收集值经自定义回发汇总弹出。 */
@FineUIPage("grid-input/radio-button-list")
public class RadioButtonListPage extends PageBase {
