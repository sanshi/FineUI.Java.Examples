...
/** 编辑框（复选框）（路由 {@code grid-input/check-box-list}）：单元格内渲染表单控件，客户端收集值经自定义回发汇总弹出。 */
@FineUIPage("grid-input/check-box-list")
public class CheckBoxListPage extends PageBase {
