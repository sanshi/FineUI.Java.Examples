...
/** 编辑框（上下键选中行）（路由 {@code grid-input/select-row-up-down}）：单元格内渲染表单控件，客户端收集值经自定义回发汇总弹出。 */
@FineUIPage("grid-input/select-row-up-down")
public class SelectRowUpDown extends PageBase {
