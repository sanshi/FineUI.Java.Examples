 ...
 * 一个<b>常驻</b>通知框（不自动消失、无标题栏），框内链接点击时调用父页面 {@code addExampleTab} 添加选项卡
...
public class NotifyAddTab extends PageBase {
    ...
    public void btnOperation1_Click(Object sender, EventArgs e) {
        // 随机生成通知框的客户端 ID，供框内链接回调里 F(notifyId).hide() 定位关闭
        String notifyId = UUID.randomUUID().toString();
        String html = "<div class=\"addtabcontainer\"><a href=\"javascript:openExampleHello('"
