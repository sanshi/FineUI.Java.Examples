...
/**
 * 树表格 · 仅文件夹可勾选（路由 {@code grid-tree/check-box-only-folder-check}）：开启行复选框且
 * tree-only-folder-check，仅文件夹可勾选。「获取选中的复选框」按钮经自定义事件回发、服务端写入结果标签。
 */
@FineUIPage("grid-tree/check-box-only-folder-check")
