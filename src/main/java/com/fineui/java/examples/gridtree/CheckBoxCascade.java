...
/**
 * 树表格 · 级联复选框（路由 {@code grid-tree/check-box-cascade}）：开启行复选框且 tree-cascade-check，
 * 勾选父节点级联勾选子孙。「获取选中的复选框」按钮经自定义事件回发、服务端写入结果标签。
 */
@FineUIPage("grid-tree/check-box-cascade")
public class CheckBoxCascade extends PageBase {
