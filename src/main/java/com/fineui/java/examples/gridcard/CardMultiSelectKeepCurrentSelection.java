...
/** 卡片选择（保持选中项）（路由 {@code grid-card/card-multi-select-keep-current-selection}）。 */
@FineUIPage("grid-card/card-multi-select-keep-current-selection")
public class CardMultiSelectKeepCurrentSelection extends PageBase {
