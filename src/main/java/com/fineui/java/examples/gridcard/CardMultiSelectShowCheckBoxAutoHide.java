...
/** 卡片选择（多选，显示多选框，自动隐藏）（路由 {@code grid-card/card-multi-select-show-check-box-auto-hide}）。 */
@FineUIPage("grid-card/card-multi-select-show-check-box-auto-hide")
public class CardMultiSelectShowCheckBoxAutoHide extends PageBase {
