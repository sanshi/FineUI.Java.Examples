...
/** 卡片选择（只能通过多选框选择）（路由 {@code grid-card/card-multi-select-check-box-only}）。 */
@FineUIPage("grid-card/card-multi-select-check-box-only")
public class CardMultiSelectCheckBoxOnly extends PageBase {
