...
/** 卡片模式（数据库分页，路由 {@code grid-card/card-paging-database}）：每次翻页回发只取当前页。 */
@FineUIPage("grid-card/card-paging-database")
public class CardPagingDatabase extends PageBase {
