...
/**
 * 跨页保持选中行（数据库分页 + 客户端缓存明细，路由 {@code grid-paging/clear-selection-before-paging-database-details}）。
 */
@FineUIPage("grid-paging/clear-selection-before-paging-database-details")
public class ClearSelectionBeforePagingDatabaseDetails extends PageBase {
