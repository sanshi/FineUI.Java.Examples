...
/** 下拉列表多选（标签模式）、清空图标点击回发演示页（路由 {@code drop-down-list/multi-select-tags-clear-icon-click}）。 */
@FineUIPage("drop-down-list/multi-select-tags-clear-icon-click")
public class MultiSelectTagsClearIconClick extends PageBase {
    ...
    public void DropDownList1_ClearIconClick(Object sender, EventArgs e) {
