...
/** 下拉列表自定义项演示页（路由 {@code drop-down-list/custom-item-group-data-display-fields}）。 */
@FineUIPage("drop-down-list/custom-item-group-data-display-fields")
public class CustomItemGroupDataDisplayFields extends PageBase {
