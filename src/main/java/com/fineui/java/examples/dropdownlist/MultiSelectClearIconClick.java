...
/** 下拉列表多选、清空图标点击回发演示页（路由 {@code drop-down-list/multi-select-clear-icon-click}）。 */
@FineUIPage("drop-down-list/multi-select-clear-icon-click")
public class MultiSelectClearIconClick extends PageBase {
