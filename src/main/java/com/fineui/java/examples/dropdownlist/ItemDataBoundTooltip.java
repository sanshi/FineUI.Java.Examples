...
/** 下拉列表自定义项演示页（路由 {@code drop-down-list/item-data-bound-tooltip}）。 */
@FineUIPage("drop-down-list/item-data-bound-tooltip")
public class ItemDataBoundTooltip extends PageBase {
    ...
    public void DropDownList1_ItemDataBound(Object sender, ListItemEventArgs e) {
        ...
        e.getItem().getAttributes().put("data-qtip", "<div class=\"item-text\">" + s.name() + "（" + s.id() + "）</div><div class=\"item-desc\">" + s.desc() + "</div>");
    }
