...
/** 下拉列表多选（标签模式）演示页（路由 {@code drop-down-list/multi-select-tags-check-box-select}）。 */
@FineUIPage("drop-down-list/multi-select-tags-check-box-select")
public class MultiSelectTagsCheckBoxSelect extends PageBase {
