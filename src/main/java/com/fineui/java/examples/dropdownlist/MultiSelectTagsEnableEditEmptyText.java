...
/** 下拉列表多选（标签模式）演示页（路由 {@code drop-down-list/multi-select-tags-enable-edit-empty-text}）。 */
@FineUIPage("drop-down-list/multi-select-tags-enable-edit-empty-text")
public class MultiSelectTagsEnableEditEmptyText extends PageBase {
