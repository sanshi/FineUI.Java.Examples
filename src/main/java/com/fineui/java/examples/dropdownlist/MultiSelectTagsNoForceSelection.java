...
/** 下拉列表多选（标签模式）演示页（路由 {@code drop-down-list/multi-select-tags-no-force-selection}）。 */
@FineUIPage("drop-down-list/multi-select-tags-no-force-selection")
public class MultiSelectTagsNoForceSelection extends PageBase {
