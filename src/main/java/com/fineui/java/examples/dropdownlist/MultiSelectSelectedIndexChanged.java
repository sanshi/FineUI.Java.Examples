...
/** 下拉列表多选、选中项改变即回发演示页（路由 {@code drop-down-list/multi-select-selected-index-changed}）。 */
@FineUIPage("drop-down-list/multi-select-selected-index-changed")
public class MultiSelectSelectedIndexChanged extends PageBase {
