...
/**
 * 选中前确认演示页（路由 {@code drop-down-list/before-select}）：客户端 beforeselect 监听里用 window.confirm 询问，
 * 取消（返回 false）则不改变选中项。「获取选中项」回发读取当前选中项。
 */
@FineUIPage("drop-down-list/before-select")
public class BeforeSelect extends PageBase {
