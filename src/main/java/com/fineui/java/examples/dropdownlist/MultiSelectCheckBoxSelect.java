...
/**
 * 下拉列表多选演示页（路由 {@code drop-down-list/multi-select-check-box-select}）。
 */
@FineUIPage("drop-down-list/multi-select-check-box-select")
public class MultiSelectCheckBoxSelect extends PageBase {
