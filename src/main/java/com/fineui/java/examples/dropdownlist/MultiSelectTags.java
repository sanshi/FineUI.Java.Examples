...
/**
 * 下拉列表多选演示页（路由 {@code drop-down-list/multi-select-tags}）：多选下拉，服务端设置选中项、
 * 读取选中项文本与全部选中值。
 */
@FineUIPage("drop-down-list/multi-select-tags")
public class MultiSelectTags extends PageBase {
