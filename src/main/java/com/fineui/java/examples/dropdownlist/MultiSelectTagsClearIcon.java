...
/** 下拉列表多选（标签模式）演示页（路由 {@code drop-down-list/multi-select-tags-clear-icon}）。 */
@FineUIPage("drop-down-list/multi-select-tags-clear-icon")
public class MultiSelectTagsClearIcon extends PageBase {
