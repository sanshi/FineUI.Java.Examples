...
/**
 * 下拉列表多选演示页（路由 {@code drop-down-list/multi-select-enable-edit}）。
 */
@FineUIPage("drop-down-list/multi-select-enable-edit")
public class MultiSelectEnableEdit extends PageBase {
