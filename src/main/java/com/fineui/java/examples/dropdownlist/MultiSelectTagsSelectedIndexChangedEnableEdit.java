...
/** 下拉列表多选（标签模式）、选中项改变即回发演示页（路由 {@code drop-down-list/multi-select-tags-selected-index-changed-enable-edit}）。 */
@FineUIPage("drop-down-list/multi-select-tags-selected-index-changed-enable-edit")
public class MultiSelectTagsSelectedIndexChangedEnableEdit extends PageBase {
