...
public class TinyMCEConfig extends PageBase {
    ...
    public void Page_Load(Object sender, EventArgs e) {
        ...
        opts.put("menubar", false);
        opts.put("plugins", java.util.List.of("link", "code", "textcolor colorpicker"));
        opts.put("toolbar1", "bold italic underline strikethrough | numlist bullist | alignleft aligncenter alignright | link unlink | code");
