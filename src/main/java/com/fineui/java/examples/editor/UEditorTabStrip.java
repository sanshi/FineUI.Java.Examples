...
/** UEditor 选项卡（路由 {@code editor/ueditor-tab-strip}）：两个编辑器分布在两个选项卡中；服务端获取两个编辑器的值。 */
@FineUIPage("editor/ueditor-tab-strip")
public class UEditorTabStrip extends ThirdPartyEditorPageBase {
