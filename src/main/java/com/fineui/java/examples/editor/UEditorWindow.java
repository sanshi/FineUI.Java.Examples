...
/** UEditor 窗体内编辑器（路由 {@code editor/ueditor-window}）：编辑器位于非模态窗体中；服务端获取/设置编辑器内容。 */
@FineUIPage("editor/ueditor-window")
public class UEditorWindow extends ThirdPartyEditorPageBase {
