...
/** CKEditor 窗体内编辑器（路由 {@code editor/ckeditor-window}）：编辑器位于非模态窗体中；服务端获取/设置编辑器内容。 */
@FineUIPage("editor/ckeditor-window")
public class CKEditorWindow extends ThirdPartyEditorPageBase {
    ...
    public void Page_Load(Object sender, EventArgs e) {
        ...
        opts.put("baseFloatZIndex", 99999);
