...
/** CKEditor 双编辑器（路由 {@code editor/ckeditor-two}）：正文/摘要两个编辑器；“更新文章摘要”服务端把正文去标签后回填摘要。 */
@FineUIPage("editor/ckeditor-two")
public class CKEditorTwo extends ThirdPartyEditorPageBase {
