...
/** DatePicker 示例（路由 {@code date-picker/date-picker-year-range}）。 */
@FineUIPage("date-picker/date-picker-year-range")
public class DatePickerYearRange extends PageBase {
