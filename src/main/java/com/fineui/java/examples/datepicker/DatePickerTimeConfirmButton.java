...
/** DatePicker 示例（路由 {@code date-picker/date-picker-time-confirm-button}）。 */
@FineUIPage("date-picker/date-picker-time-confirm-button")
public class DatePickerTimeConfirmButton extends PageBase {
