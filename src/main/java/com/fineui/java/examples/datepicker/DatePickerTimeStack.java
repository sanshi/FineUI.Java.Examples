...
/** DatePicker 示例（路由 {@code date-picker/date-picker-time-stack}）。 */
@FineUIPage("date-picker/date-picker-time-stack")
public class DatePickerTimeStack extends PageBase {
