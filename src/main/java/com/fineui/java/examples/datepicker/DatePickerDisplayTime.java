...
/** DatePicker 示例（路由 {@code date-picker/date-picker-display-time}）。 */
@FineUIPage("date-picker/date-picker-display-time")
public class DatePickerDisplayTime extends PageBase {
