...
/** DatePicker 示例（路由 {@code date-picker/date-picker-display-year}）。 */
@FineUIPage("date-picker/date-picker-display-year")
public class DatePickerDisplayYear extends PageBase {
