...
/** DatePicker 示例（路由 {@code date-picker/date-picker-time-range}）。 */
@FineUIPage("date-picker/date-picker-time-range")
public class DatePickerTimeRange extends PageBase {
