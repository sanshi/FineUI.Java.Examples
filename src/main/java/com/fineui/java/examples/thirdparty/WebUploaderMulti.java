...
/** 并排两个上传组件的 WebUploader 示例。 */
@FineUIPage("third-party/web-uploader-multi")
public class WebUploaderMulti extends WebUploaderPageBase {

    private static final String OWNER1 = "webuploader.webuploader_multi.1";
    private static final String OWNER2 = "webuploader.webuploader_multi.2";
