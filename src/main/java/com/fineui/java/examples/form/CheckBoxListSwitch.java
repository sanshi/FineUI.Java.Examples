...
/**
 * 复选框列表 - 开关样式演示页（路由 {@code form/check-box-list-switch}）：各项以开关（{@code DisplayType=Switch}）
 * 形式呈现，功能与普通复选框列表一致（服务端设置/获取、选中项改变事件、开关文本 {@code SwitchOnText/SwitchOffText}）。
 */
@FineUIPage("form/check-box-list-switch")
public class CheckBoxListSwitch extends PageBase {
