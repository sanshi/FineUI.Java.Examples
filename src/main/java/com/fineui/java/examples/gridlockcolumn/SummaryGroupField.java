...
/** 列锁定 + 合计 + 多表头 + 行扩展列（路由 {@code grid-lock-column/summary-group-field}）：列锁定 + 数据库分页 + 全部合计。 */
@FineUIPage("grid-lock-column/summary-group-field")
public class SummaryGroupField extends PageBase {
